...
class FilePickerLineEdit(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)

        self.line_edit = QLineEdit(self)
        self.line_edit.setPlaceholderText("Select a file or folder...")

        self.button = QPushButton("▼", self)
        self.button.setFixedWidth(30)
        self.button.setToolTip("Choose file or folder")

        # Create dropdown menu
        self.menu = QMenu(self)
        self.menu.addAction("Select File", self.select_file)
        self.menu.addAction("Select Folder", self.select_folder)
...
class ChooseDataSetWidget(QWidget):
    def __init__(self):
        ...
        self.directory_input = FilePickerLineEdit()
...
class MainWindow(QWidget):
    def __init__(self, choose_dataset_widget: ChooseDataSetWidget, data_collection_widget: DataCollectionWidget, data_creation_widget: CreateDatasetWidget):
        super().__init__()
        ...
        self.data_collection_widget = data_collection_widget
        self.data_creation_widget = data_creation_widget
        self.choose_dataset_widget = choose_dataset_widget

        layout.addWidget(data_collection_widget)
        layout.addWidget(data_creation_widget)
        layout.addWidget(choose_dataset_widget)
    ...
    def navigate (self, page):
        ...
        self.data_creation_widget.hide()
        self.choose_dataset_widget.hide()

        match (page):
            case 0:
                self.data_collection_widget.show()
            case 1:
                self.data_creation_widget.show()
            case 2:
                self.choose_dataset_widget.show()
